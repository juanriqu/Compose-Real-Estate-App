package com.example.composerealstate.data.repository

import com.example.composerealstate.data.local.DaoHouseLocal
import com.example.composerealstate.data.model.toHouse
import com.example.composerealstate.data.remote.HouseRemoteDataSource
import com.example.composerealstate.domain.model.House
import com.example.composerealstate.domain.model.toHouseEntity
...
class HouseRepository @Inject constructor(
     ...
     */
    suspend fun getAllHousesCached(): NetworkResult<List<House>> {
