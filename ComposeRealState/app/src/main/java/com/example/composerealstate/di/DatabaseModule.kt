...
import com.example.composerealstate.data.local.AppDatabase
...
/**
 * This class is used to provide instances of the AppDatabase and HouseDao classes, which are used to access the app's local database.
 */
@Module
